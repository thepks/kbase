    ...
    return {
        ...
        updateEventHandler: function() {
            ...
            $(guidesPage).find('.resultDelete').click(function(evt) {
                ...
                promise_delete.done(function(data, status, jqXHR) {
                ...
                promise_delete.fail(function(data, status) {
            ...
            $(guidesPage).find('.resultEdit').click(function(evt) {
                ...
                promise_edit.done(function(data, status, jqXHR) {
                ...
                promise_edit.fail(function(data, status, jqXHR) {
                    console.log('Error! ' + JSON.stringify(data));
                });
        ...
        search: function() {
            ...
            promise_search.done(function(data, status, jqXHR) {
                ...
                if ($(guidesPage).find('#manage').is(':visible')) {
                    $(guidesPage).find('.editNav').slideToggle("fast");
                }

                self.updateEventHandler();
            });
            promise_search.fail(function(data, status) {
                console.log('Error! ' + data);
            });
